...
class Restaurant:
    def __init__(self, name, address, phone, rating, menu):
        self.name = name
...
def main():
    ...
    # List of Objects :)
    dishes = [Dish(name="Dal Makhani",
                   price=350,
                   rating=4.5), dish2, dish3, dish4, dish5]

    menu = Menu(title="Indian Delight",
                num_of_dishes=len(dishes),
                dishes=dishes)
